...
function RegisterMethodPage() {
  return (
    <div className=' min-h-screen max-w-screen-sm mx-auto my-auto flex items-center justify-center flex-col p-12 '>
      <div className='flex justify-center items-center flex-col'>
        <img src={logo} alt='logo' className=' w-[60px]' />
        <h1 className='font-bold text-3xl mt-4'>Join the DEV Community</h1>
